package com.sideproject.musinsa_backend.Common.configs;

import com.sideproject.musinsa_backend.Common.auth.JwtAuthFilter;
...
//                특정 url패턴에 대해서는 Authentication객체 요구하지 않음.(인증처리 제외)
                .authorizeHttpRequests(a -> a.requestMatchers("/employee/create", "/employee/doLogin", "/connect/**", "/connect").permitAll().anyRequest().authenticated())
